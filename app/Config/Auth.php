...
class Auth extends ShieldAuth
{
   ...
   public array $actions = [
    //'login'    => \CodeIgniter\Shield\Authentication\Actions\Login::class,
    //'register' => \CodeIgniter\Shield\Authentication\Actions\Register::class,
    //'logout'   => \CodeIgniter\Shield\Authentication\Actions\Logout::class, // <-- TAMBAHKAN BARIS INI
];
